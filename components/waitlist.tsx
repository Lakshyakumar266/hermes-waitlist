  ...
  overflow-x: hidden;
      ...
      <div
        style={{
          minHeight: "100vh",
          background: `
  radial-gradient(ellipse 80% 60% at 72% 38%, #ffffff10 0%, transparent 65%),
  radial-gradient(ellipse 60% 40% at 78% 55%, #ffe0a008 0%, transparent 70%),
  radial-gradient(ellipse 50% 30% at 30% 80%, #ffffff03 0%, transparent 70%),
  #090909
`,
          position: "relative",
        }}
      >
        ...
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(ellipse 70% 40% at 70% 20%, #ffffff06, transparent 70%)",
          }}
        />
